...
This document was generated for AI-collaboration and discussion purposes. It is retained in `project/_scratch/` for reference but should not be treated as authoritative policy or operational guidance.

For authoritative project planning, see [project/ROADMAP.md](../../project/ROADMAP.md).
